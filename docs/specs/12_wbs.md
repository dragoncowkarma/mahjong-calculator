...
| WBS ID | 마일스톤 | 담당 | 선행 작업 | 소요 기간 | 산출물 | 비고 |
|:---|:---|:---|:---|:---|:---|:---|
| 2.1 | **02001** YOLO 학습 | Jules | 01005(Gate) | 2주 | 학습된 YOLO 모델 (mAP ≥ 95%) | 🔴 크리티컬 패스 |
| 2.2 | **02002** 모델 내보내기 | Antigravity | 02001 | 1주 | .tflite, .mlmodel (≤ 10MB 각) | 🔴 크리티컬 패스 |
| 2.3 | **02003** 추론 인터페이스 | Jules | 02002 | 1주 | MahjongDetector 인터페이스, NMS 후처리 | 🔴 크리티컬 패스 |
...
| 에이전트 | Phase 1 | Phase 2 | Phase 3 | Phase 4 | 총 작업 수 |
|:---|:---:|:---:|:---:|:---:|:---:|
| **Jules** | 3 | 2 | 1 | 2 | **8** |
| **Antigravity** | 1 | 3 (+α) | 3 (+β) | 1 | **8+** |
| **Gemini CLI** | 1 | 1 | 1 (+β) | 1 | **4+** |
